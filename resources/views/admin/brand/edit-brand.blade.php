                ...
                <form action="{{ url('admin/brand/update/'.$brand->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $brand->name }}" id="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="Enter Brand Name">
                            @if($errors->has('name'))
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary fa-pull-right">Update Brand</button>
